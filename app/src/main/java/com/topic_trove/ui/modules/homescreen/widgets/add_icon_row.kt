...
fun AddImageRow(
    ...
    Row{
        Text(text = "Community icon", style = CustomTextStyle.titleFieldCreatePost())
        Spacer(modifier = Modifier.width((screenWidth*0.4).dp))
        Button(onClick = { onClick() }, colors = ButtonDefaults.buttonColors(
            ...
            Text(text = "Add Icon", style = CustomTextStyle.addImgButtonCommunity())
        }
    }
}